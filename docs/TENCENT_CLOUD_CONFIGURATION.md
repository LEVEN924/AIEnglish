...
- ASR：合成诊断音频的真实识别请求成功，`16k_en`，约 550 ms。
- **SOE-N 尚不可用：真实握手返回 `4003：账号未开通本服务，请在控制台开通服务`。**请使用对应 AppID 所属账号进入[新版口语评测控制台](https://console.cloud.tencent.com/soenew)开通服务，再复测。填写密钥和签名生成成功不等于服务已开通。[官方错误码说明](https://cloud.tencent.com/document/product/1774/107497)。本次未擅自开通计费、购买资源包或变更密钥。
- ASR/SOE-N 诊断使用明确标记的合成音频，没有写入真人学习成绩，不构成手机/平板真人麦克风验收。
