...
当前交付包含 1000 篇已入 SQLite 的 L1/L2/L3 内容（350/400/250）、可追溯来源、跳过本篇、跨设备进度、版本化批改、自动错题、1/3/7 天间隔复习、生词本、七日周报、PWA、一键启停、启动前备份以及可选局域网 HTTPS。OpenAI 密钥未配置时，量表评分、浏览器朗读、浏览器转写/手动文本降级仍可用。
