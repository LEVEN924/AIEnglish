...
2026-08-26：已部署并接管原应用入口，正式访问地址为 [https://cayi-ai.top:20057](https://cayi-ai.top:20057)。已修正公网端口来源校验、放宽 Nginx 录音上传至 16 MiB，并完成腾讯口语评分及 64 秒合成录音上传/评分/回听实测；真人移动端录音仍需验收，详见[实际部署状态](docs/SERVER_DEPLOYMENT.md)。
